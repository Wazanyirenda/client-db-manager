...
export function SignupForm() {
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      {/* Google Sign Up Button - pinned at top, never scrolls */}
      <div className="flex-shrink-0 space-y-4 pb-4">
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 h-11 px-4 rounded-lg bg-white hover:bg-gray-50 text-gray-900 font-medium border-2 border-gray-200 shadow-sm transition-all hover:border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
      ...
      {/* Form wraps fields + submit so form submission works */}
      <form onSubmit={handleSubmit} className="flex-1 min-h-0 flex flex-col">
        {/* === SCROLLABLE AREA — only the input fields scroll === */}
        <div className="flex-1 min-h-0 overflow-y-auto space-y-5 pr-1">
          ...
          {/* Error & success inside scrollable area */}
          {error && (
        ...
        {/* Submit button + sign-in link — pinned at bottom, never scrolls */}
        <div className="flex-shrink-0 pt-4 pb-1 space-y-2 bg-white">
          <Button 
            type="submit" 
